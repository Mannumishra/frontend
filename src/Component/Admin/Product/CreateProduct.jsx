                  ...
                  <form action="" >
                     <div className="row">
                        ...
                        <div className='col'>
                           ...
                           <input type="text" className="form-control" name='brand' onChange={getInputData} required placeholder="Product Brand name" />
                        </div>
                        <div className='col'>
                           <label htmlFor="">Product Category <span className='text-danger'>*</span></label>
                           <input type="text" className="form-control" name='maincategory' onChange={getInputData} required placeholder="Product Category name" />
                        </div>
                     </div>
                     <div className="row">
                        <div className='col'>
                        ...
                        <div className='col'>
                           ...
                           <input type="text" className="form-control" name='size' onChange={getInputData} required placeholder="Product Size " />
                        </div>
                        <div className='col'>
